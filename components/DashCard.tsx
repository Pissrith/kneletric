...
const DashCard: React.FC<DashCardProps> = ({
  ...
  const cardClassName = `rounded-lg border bg-primary text-card-foreground shadow-sm `;
  const textClassName = `tracking-tight text-background text-xs sm:text-xl md:text-2xl font-medium`;
